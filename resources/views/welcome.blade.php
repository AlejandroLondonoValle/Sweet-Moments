...
<body class="flex flex-col min-h-screen">
    <header class="bg-blue-100 py-4">
        <nav class="container mx-auto px-4 flex justify-between items-center">
            <!-- Logo a la izquierda -->
            <img src="{{ asset('img/logo.webp') }}" alt="Logo" class="w-20 h-20 fill-current text-blue-600" />
            <!-- Título a la izquierda -->
            <a href="#" class="text-2xl font-bold text-blue-600">SweetMoments</a>

            <!-- Enlaces de Login y Register a la derecha -->
            <div class="ml-auto flex space-x-4">
                <a href="{{ route('login') }}"
                    class="rounded-md px-3 py-2 text-white bg-[#004F64] ring-1 ring-transparent transition hover:bg-[#003b47] focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                    Log in
                </a>
    ...
    <main class="flex-grow">
        <section class="relative h-[70vh] flex items-center justify-center bg-cover bg-center">
            ...
            <div class="relative z-10 text-center text-white">
                <h1 class="text-5xl font-bold mb-4 animate-fade-in-down text-blue-600">Bienvenidos a SweetMoments</h1>
                <p class="text-xl mb-8 animate-fade-in-up text-blue-600">Donde cada bocado es un momento de felicidad
                </p>
                <a href="#"
    ...
    <footer class="bg-blue-200 py-8">
        <div class="container mx-auto px-4 flex flex-wrap justify-between">
            <div class="w-full md:w-1/3 mb-4 md:mb-0">
                <h3 class="text-xl font-semibold mb-4 text-blue-600">SweetMoments</h3>
